...
> 77 Copilot modül farkındalığı, 78 Gruplu navigasyon, 79 Postgres deploy
> düzeltmesi, 80 Pazarlama Fırsat Takvimi. Bildirim/Alarm Merkezi (9) zaten mevcut.
> Kalan no-cred adaylar: Çoklu-dil (7, riskli — kullanıcı incelemesinde), Veri
> dışa aktarma (10, kısmen mevcut), RBAC ince-izin (3).
