...
4. **AI Haftalık Strateji / Proaktif Öneri Merkezi** — haftalık doğal-dil
   strateji + öneri kuyruğu (kabul/atla). (Dalga 70)
5. **KVKK / Consent Yönetim Merkezi** — TR-first: tüm consent ayarları + rıza
   denetim izi tek yerde. (Dalga 71)
6. **Onboarding Sihirbazı** — ilk kurulum: hesap bağla → hedef koy → ilk
   içerik/bütçe; sellability. (Dalga 72)
7. **Çoklu-dil (TR/EN)** — global hedef için arayüz dil anahtarı. (Dalga 73)
8. **Benchmark / sektör kıyas** — sentetik sektör ortalamasına göre konum. (Dalga 74)
9. **Bildirim/Alarm Merkezi UI** + kural derinleştirme. (Dalga 75)
10. **Veri dışa aktarma / paylaşılabilir özet** derinleştirme. (Dalga 76)
