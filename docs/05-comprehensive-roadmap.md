...
| **M10 — Abonelik & Faturalama** | iyzico/Stripe, planlar, entitlement, kullanım | — | 🔵 Bu dalga (canlı için kimlik bekler) |
...
- **Dalga 7 (şimdi):** Abonelik & faturalama (M10, iyzico/Stripe soyutlama + plan/entitlement) · CI + sağlamlaştırma · Faturalama UI.
- **Dalga 8:** Çoklu hesap / Ajans / white-label (M8).
