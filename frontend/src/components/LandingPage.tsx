...
// Fiyat/limit bilgileri backend'deki plan tanımlarının (billing.PLANS)
// birebir yansımasıdır — /billing ekranıyla çelişmemeli. Plan değişirse
...
const PRICING_PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Tüm AI içgörüleri + anomali tespiti',
      'E-posta + Slack uyarıları',
      'White-label raporlar',
      'Çoklu müşteri hesabı',
    ],
    cta: 'Başla',
    highlighted: true,
  },
